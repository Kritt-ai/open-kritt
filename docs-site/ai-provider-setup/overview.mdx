...
<CardGroup cols={2}>
  ...
  <Card title="Abliteration" icon="bolt" href="/ai-provider-setup/abliteration">
...
<Steps>
  ...
  <Step title="Choose one access method">
    ...
    **OpenRouter API key**, or **Abliteration API key**. Follow the provider guide above
...
OpenRouter and Abliteration keys synchronized with `.env`, and mirrors those keys under
